...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  await db.execute(sql`
   CREATE TYPE "public"."enum_users_role" AS ENUM('butler', 'admin');
  CREATE TYPE "public"."enum_orders_status" AS ENUM('pending', 'preparing', 'completed', 'canceled');
  ...
  CREATE TABLE "users" (
  	...
  	"role" "enum_users_role" DEFAULT 'butler' NOT NULL,
  ...
  ALTER TABLE "orders_items" ADD CONSTRAINT "orders_items_menu_item_id_menu_items_id_fk" FOREIGN KEY ("menu_item_id") REFERENCES "public"."menu_items"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "orders_items" ADD CONSTRAINT "orders_items_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."orders"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "orders" ADD CONSTRAINT "orders_handled_by_id_users_id_fk" FOREIGN KEY ("handled_by_id") REFERENCES "public"."users"("id") ON DELETE set null ON UPDATE no action;
  ...
  CREATE UNIQUE INDEX "menu_categories_name_idx" ON "menu_categories" USING btree ("name");
  ...
  CREATE INDEX "orders_items_menu_item_idx" ON "orders_items" USING btree ("menu_item_id");
  CREATE INDEX "orders_handled_by_idx" ON "orders" USING btree ("handled_by_id");
